...
export const Footer = (): ReactElement => {
  ...
  return (
    <footer className="w-full border-t border-gray-900 bg-black px-4 py-12 text-gray-400">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex flex-col items-center gap-4 md:items-start">
          ...
          <a
            ...
            className="group/address flex items-center gap-2 text-sm text-[var(--accent)]/80 transition-all hover:text-[var(--primary-hover)]"
          >
            <MapPin className="h-4 w-4 text-[var(--primary)] transition-transform group-hover/address:scale-110" />
            <span>{t('footer.address')}</span>
          </a>
        </div>

        <div className="flex flex-col items-center gap-4 text-sm md:flex-row md:gap-8">
          <Link to="/politicas" className="transition-colors hover:text-[var(--primary)]">
            {t('footer.privacy')}
          </Link>
          <Link to="/politicas" className="transition-colors hover:text-[var(--primary)]">
            {t('footer.terms')}
        ...
        <div className="flex items-center gap-6">
          {socialLinks.map((social) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="transform transition-all hover:scale-110 hover:text-[var(--primary)]"
