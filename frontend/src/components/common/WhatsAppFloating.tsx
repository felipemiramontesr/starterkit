...
export const WhatsAppFloating = ({ isShifted }: WhatsAppFloatingProps): ReactElement => {
  ...
  return (
    <a
      ...
      className={`group fixed z-[110] h-16 flex items-center justify-center bg-emerald-500 hover:bg-emerald-400 text-white rounded-full shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all duration-500 ease-in-out transform hover:scale-105 active:scale-95 overflow-hidden w-16 hover:w-[240px] px-0 hover:px-8 ${
        isShifted 
